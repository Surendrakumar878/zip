  ...
  return (
    <>
      ...
      <div>
        ...
        {/* imgae */}
        <div className=" w-12/12 m-auto  relative border my-20">
          <img
            className="h-96 object-cover w-full"
            src={`http://localhost:7001/${data?.mainTitleImg}`}
            alt=""
          />
          <div className="flex gap-5 items-center justify-center absolute top-full -translate-x-1/2 left-1/2 -translate-y-1/2" >
            <span className="h-24 w-24 rounded-xl border-4 border-white" >
              <img className="rounded-xl w-full h-full object-cover" src={`http://localhost:7001/${data?.title1img}`} alt="" />
            </span>
            <span className="h-24 w-24 rounded-xl border-4 border-white" >
              <img className="rounded-xl w-full h-full object-cover" src={`http://localhost:7001/${data?.title4img}`} alt="" />
            </span>
            <span className="h-24 w-24 rounded-xl border-4 border-white" >
              <img className="rounded-xl w-full h-full object-cover" src={`http://localhost:7001/${data?.title3img}`} alt="" />
            </span>
          </div>
        </div>
        ...
        <div className="w-10/12 m-auto flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-5">
            <span className="text-xl font-bold"> ICONSQUARE</span>
            {/* <img
          ...
          <div className="flex flex-col gap-5">
            <span className="text-xl font-bold"> SPROUTE SOCIAL</span>
            {/* <img
              className="md:w-7/12 w-full"
          ...
          <div className="flex flex-col gap-5">
            <span className="text-xl font-bold"> HOOTSUITE</span>
            {/* <img
              className="md:w-7/12 w-full"
          ...
          <div className="flex flex-col gap-5">
            <span className="text-xl font-bold"> AGORAPLUSE</span>
            {/* <img
              className="md:w-7/12 w-full"
          ...
          <div className="flex flex-col gap-5">
            <span className="text-xl font-bold"> SENDIBLE</span>
            {/* <img
              className="md:w-7/12 w-full"
        ...
        <div className="flex flex-col gap-5  w-10/12 m-auto py-6 ">
          <span className="text-xl font-bold"> AGORAPLUSE</span>
          {/* <img
            className="md:w-7/12 w-full"
            src={`http://localhost:7001/${data?.title4img}`}
